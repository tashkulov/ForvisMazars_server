...
exports.getSchedule = async (req, res) => {
    try {
        ...
        console.error('Error fetching schedule data:', error); // Для отладки
...
exports.createBlock = async (req, res) => {
    try {
        ...
        console.error('Theres something wrong:', error); // Для отладки
        res.status(500).json({ message: 'Theres something wrong' });
    }
};
...
exports.updateBlock = async (req, res) => {
    try {
        ...
        console.error('Error updating block:', error); // Для отладки
...
exports.deleteBlock = async (req, res) => {
    try {
        ...
        console.error('Error deleting block:', error); // Для отладки
